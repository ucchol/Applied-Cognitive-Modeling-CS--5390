# -*- coding: utf-8 -*-
"""
Created on Thu Mar  9 20:11:57 2023
...
def run(output_file=DEFAULT_OUTPUT_FILE):
    ...
    # attack_agent = pyibl.Agent("Attack Agent", optimized_learning=False)
    ...
    return [attack_failed / (TRIALS * PARTICIPANTS), attack_successful / (TRIALS * PARTICIPANTS),
            attack_withdraw / (TRIALS * PARTICIPANTS)]
